...
public class TagServiceImpl implements TagService {
    ...
    public void initializeTagGraph() {
        ...
        System.out.println("⚠️  标签图初始化已改为手动执行");
        System.out.println("⚠️  请在 Neo4J Browser 中执行 backend/init_neo4j_tags.cypher 脚本");
        System.out.println("⚠️  或者使用 Neo4J Browser 手动创建标签和关系");
    }
